...
public class Grade extends JPanel implements ActionListener
{
    ...
    private void carregaImagens(){
        ...
        ImageIcon bola_ = new ImageIcon("src/resources/bola.png");
        bola = bola_.getImage();

        // Cria um icone do arquivo png e seta na imagem correspondente
        ImageIcon comida_ = new ImageIcon("src/resources/comida.png");
        comida = comida_.getImage();

        // Cria um icone do arquivo png e seta na imagem correspondente
        ImageIcon cabeça_ = new ImageIcon("src/resources/cabeca.png");
    ...
    private void initDesenhando (Graphics g){
    ...
    public void desenharPontuacao (Graphics g)
    {
        ...
        g.drawString(SCORE, (B_WIDTH - SCORE_METRICA.stringWidth(SCORE)) - 10, B_HEIGHT - 10);
    }
    ...
    public void FimDeJogo (Graphics g)
    {
        ...
        g.setFont(pequena);
        // Desenha a fonte na tela
        g.drawString(msg, (B_WIDTH - metrica.stringWidth(msg)) / 2, B_HEIGHT / 2);
    }
